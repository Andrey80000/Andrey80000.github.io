    ...
    methods: {
        ...
        line: function(item) {
            setTimeout(function() {
                ...
                document.getElementById('chartOuter').innerHTML = '<div id="chartHints"><div class="chartHintsViews">Views</div><div class="chartHintsClick">Clicks</div></div><canvas id="myChart"></canvas>'
            ...
            <div class="panelTop">
                <div class="wrapper">
                    <div class="flex">
                        ...
                        <div class="w50"></div>
                        <div class="w20 ar ptb20 pb0">
                            <a href="#" class="btnS" @click.prevent="parent.formData=user;$refs.new.active=1"><i class="fas fa-edit"></i> Edit user</a>
                        </div>
                    </div>
                    <div class="flex ptb15" v-if="data && data.info">
                        <div class="w50">
            ...
            <div class="wrapper">
                ...
                <div v-if="tab == 1">
                    ...
                    <popup ref="chart" fullscreen="true" title="Chart">
                        ...
                        <div class="flex body">
                            <div class="w30 al filchart"></div>
                            <div class="w70" id="chartOuter">
                                <div id="chartHints">
                                    <div class="chartHintsViews">Views</div>
                                    <div class="chartHintsClick">Clicks</div>
                                </div>
                ...
                <div v-if="tab == 2">
                    <div class="flex panel">
                        ...
                        <div class="w20 al ptb15">
                            <a href="#" class="btnS" @click.prevent="parent.formData = {};$refs.payment.active = 1"><i class="fas fa-plus"></i> Add payment</a>
                        </div>
                    </div>

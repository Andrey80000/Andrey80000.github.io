            ...
            <div class="wrapper">
                <div class="flex">
                    ...
                    <div class="w10 al" id="user-top" v-if="parent.user && parent.user.user">
                        <div class="user-circle" @click="toogleActive()">{{parent.user.user[0]}}</div>

                        <i @click="toogleActive()" class="fas fa-caret-down" style="cursor: pointer;"></i>
                        <div id="user-info" :class="{active:active==1}">
                            <a href="#" @click.prevent="parent.logout();"><i class="fas fa-sign-out-alt"></i> Log out: {{parent.user.user}}</a>
                        </div>
                    </div>
                    <div class="w70">
                        <div id="menu">
